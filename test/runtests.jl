...
@safetestset "tuple_of_same_length_tuples" begin; @time include("tuple_of_same_length_tuples.jl"); end
...
@safetestset "dispatch_4th_order" begin; @time include("dispatch_4th_order.jl"); end
@safetestset "dispatch_tuple_of_same_length_tuples" begin; @time include("dispatch_tuple_of_same_length_tuples.jl"); end
